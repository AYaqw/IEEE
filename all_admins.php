                                           ...
                                           <?php foreach($admins as $admin_data){
                                            echo"<tr>";
                                                    ...
                                                    if( $admin_data['state']==0){
                                                        echo "<td>". '<span style="font-size:16px" class="badge badge-secondary">Offline</span>' ."</td>";
                                                    }else{
                                                        echo "<td>". '<span style="font-size:16px" class="badge badge-success">Online</span>' ."</td>";
                                                    }
